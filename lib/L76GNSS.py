...
class L76GNSS:
    ...
    def coordinates1(self, debug=False):
        lat_d, lon_d, gps_time, valid, gps_altitude, hdop, num_satellites, debug_timeout = None, None, None, None, None, None, False, False
        if self.timeout is not None:
            self.chrono.reset()
            self.chrono.start()
        nmea = b''
        ...
        if debug and debug_timeout:
            ...
            return(lat_d, lon_d, gps_time, gps_altitude, valid, num_satellites, hdop)
